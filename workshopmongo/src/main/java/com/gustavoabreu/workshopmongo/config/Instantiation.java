package com.gustavoabreu.workshopmongo.config;
...
import com.gustavoabreu.workshopmongo.dto.AuthorDTO;
import com.gustavoabreu.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu Viagem", "Vou viajar para São Paulo, Abç",new AuthorDTO(maria) );
